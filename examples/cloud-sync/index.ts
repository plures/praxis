...
const TaskCreated = defineFact<"TaskCreated", { id: string; title: string }>(
  "TaskCreated"
);
const TaskCompleted = defineFact<"TaskCompleted", { id: string }>(
  "TaskCompleted"
);
const CreateTask = defineEvent<"CREATE_TASK", { id: string; title: string }>(
  "CREATE_TASK"
);
const CompleteTask = defineEvent<"COMPLETE_TASK", { id: string }>(
  "COMPLETE_TASK"
);
