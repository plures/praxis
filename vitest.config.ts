...
export default defineConfig({
  resolve: {
    alias: [
      ...
      { find: /^@plures\/praxis-cloud$/, replacement: path.resolve(__dirname, 'packages/praxis-cloud/src/index.ts') },
      { find: /^@plures\/praxis\/cloud$/, replacement: path.resolve(__dirname, 'packages/praxis-cloud/src/index.ts') },
  ...
  test: {
    ...
    coverage: {
      ...
      exclude: [
        ...
        'src/causal-anomaly/**',
        'src/uncertainty/**',
        'packages/praxis-cloud/src/auth.ts',
        'packages/praxis-cloud/src/index.ts',
        'packages/praxis-cloud/src/marketplace.ts',
        'packages/praxis-cloud/src/relay/**',
        'packages/praxis-cloud/src/sponsors.ts',
        'packages/praxis-cloud/src/types.ts',
