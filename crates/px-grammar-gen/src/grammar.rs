...
mod tests {
    ...
    fn all_constructs_present() {
        ...
        for name in [
            "entity_decl", "config_decl", "fact_decl", "rule_decl",
            "constraint_decl", "contract_decl", "function_decl",
            "trigger_decl", "dataflow_procedure_decl", "procedure_decl",
            "scenario_decl", "import_decl",
        ] {
